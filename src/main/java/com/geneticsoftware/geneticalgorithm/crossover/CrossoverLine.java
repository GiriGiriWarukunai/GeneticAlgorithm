...
public class CrossoverLine extends Crossover{
            ...
            if (random.nextDouble() < crossoverRate) {
                ...
                do {
                    ...
                    for (int j = 0; j < parent1.getChromosomes()[0].getChromosomeSize(); j++) {
                        ...
                        double first = p1 - alpha * (p2 - p1);
                        double second =p2 + alpha * (p2 - p1);
                        child1[j] = first + (second - first) * random.nextDouble();
                        child2[j] = first + (second - first) * random.nextDouble();
                    }
                    crossoverAttempts++;
